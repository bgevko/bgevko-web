...
const CustomPre = ({ className, codeData, ...props }) => {
	return (
...
const MDXcomponents = {
  ...
  h6: ({ className, ...props }) => (
	...
	a: ({ className, ...props }) => (
    <a
      className={cn("font-medium underline underline-offset-4 text-blue-600", className)}
      {...props}
    />
  ),
  p: ({ className, ...props }) => (
